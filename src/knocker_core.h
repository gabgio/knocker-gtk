...
/* If in trouble .... :-) */
/* #define DEBUG */
/* and run knocker in quiet mode to se only debug output */

#ifndef _KNOCKER_CORE_VERSION_
#define _KNOCKER_CORE_VERSION_      "0.6.6"
#endif
#ifndef _KNOCKER_CORE_RELEASE_DATE_
#define _KNOCKER_CORE_RELEASE_DATE_ "9 March 2002"
#endif
